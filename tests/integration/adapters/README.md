...
drives real Telescope and Snacks selections and runs `nvim --version` through
the real Overseer task lifecycle. Exhaustive cancellation and malformed-adapter
behavior remain in the fast fake-based contracts.
