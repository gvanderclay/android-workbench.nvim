...
| --- | --- | --- |
| Lua runtime and plugin entry | Developed in the owner's dotfiles repository on 2026-08-10 and 2026-08-11, then extracted into this repository | No third-party notice found |
| Contract tests and package smoke | Developed beside the runtime in the owner's dotfiles repository, then extracted and extended here | No third-party notice found |
...
| Bundled Gradle init script | Introduced with trusted project discovery in dotfiles commit `b9d8ee4908dc12ffd404331468cd8ad59b50946d`, then extracted with the runtime | No third-party notice found |
| Build, formatting, and CI files | Added during the standalone extraction | No third-party notice found |

The dotfiles commits containing this material and every commit in the
standalone repository record Gage Vander Clay as the author. Repository-wide
searches found no copyright, SPDX, license, copied/adapted-source, vendoring, or
upstream attribution notice in the inventoried source. A comparison of
distinctive Workbench identifiers against the locally checked-out
